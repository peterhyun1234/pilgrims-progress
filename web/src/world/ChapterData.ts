...
export const CHAPTER_CONFIGS: ChapterConfig[] = [
  ...
  },
  {
    ...
    spawn: { x: 80, y: 200 },
    npcs: [
      { id: 'help', nameKo: '도움', nameEn: 'Help', sprite: 'help', x: 360, y: 180, chapter: 2 },
    ],
    exits: [
    ...
    theme: THEMES[2],
    events: [
      { id: 'ch2_battle_despair', type: 'battle', x: 500, y: 250, width: 40, height: 40, triggerOnce: true, data: { enemyId: 'despair' } },
    ],
  },
  {
    chapter: 3,
    ...
    spawn: { x: 80, y: 280 },
    npcs: [
      { id: 'worldly_wiseman', nameKo: '세속 현자', nameEn: 'Worldly Wiseman', sprite: 'worldly_wiseman', x: 300, y: 200, chapter: 3 },
    ],
    exits: [
    ...
    theme: THEMES[3],
    events: [
      { id: 'ch3_battle_tempt', type: 'battle', x: 420, y: 300, width: 40, height: 40, triggerOnce: true, data: { enemyId: 'temptation' } },
    ],
  },
  {
    chapter: 4,
    ...
    spawn: { x: 80, y: 200 },
    npcs: [
      { id: 'goodwill', nameKo: '선의', nameEn: 'Good-will', sprite: 'goodwill', x: 360, y: 180, chapter: 4 },
    ],
    exits: [
  ...
  },
  {
    ...
    spawn: { x: 240, y: 420 },
    npcs: [
      { id: 'interpreter', nameKo: '해석자', nameEn: 'Interpreter', sprite: 'interpreter', x: 240, y: 200, chapter: 5 },
    ],
    exits: [
